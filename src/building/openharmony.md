...
>
> Once the keys have been generated, you will need to move the entire directory that stores the keys (usually under `<USER HOME>/.ohos/config/openharmony`) generated by DevEco Studio from your Windows / MacOS machine. 
>
