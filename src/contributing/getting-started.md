...
#### Can I submit a PR that include code generated by AI tools?
...
#### Can I use an AI tool to write a new isue description or comment?
...
Any issues filed against the project are expected to abide by the project's AI policy—you must be able to explain your findings, not just copy and paste the machine output.
...
Comments, descriptions, and other non-code artifacts must be rewritten without the use of AI tooling.
