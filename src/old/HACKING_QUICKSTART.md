# TODO: docs/HACKING_QUICKSTART.md

<!-- https://github.com/servo/servo/blob/b79e2a0b6575364de01b1f89021aba0ec3fcf399/docs/HACKING_QUICKSTART.md -->
...
Even if you have never seen any Rust code, it's not too hard to read Servo's code.
But there are some basics things one must know:
...
This won't be enough to do any serious work at first, but if you want to navigate the code and fix basic bugs, that should do it.
It's a good starting point, and as you dig into Servo source code, you'll learn more.
